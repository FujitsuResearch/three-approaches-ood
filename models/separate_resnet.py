...
class ResNet(tf.keras.Model):
    def __init__(self, block, num_blocks, num_classes, channel_in=64, channel_out=512):
        ...
        # layer 1
        self.layer1 = self.makelayer(channel_in, 64, block, num_blocks[0])
        # Layer 2
        self.layer2 = self.makelayer(64, 128, block, num_blocks[1])
        # layer 3
        self.layer3 = self.makelayer(128, 256, block, num_blocks[2])
        # layer 4
        self.layer4 = self.makelayer(256, channel_out, block, num_blocks[3])
    ...
    def makelayer(self, channel_in, channel_out, block, num_blocks):
        ...
        for i in range(num_blocks):
            if(i==num_blocks-1):
                ...
                layer.append(block(channel_in, channel_in))
        return layer
    ...
    def call(self, x, training=None):
        ...
        return (Activation('softmax')(out_o), Activation('softmax')(out_p)), acts

    def get_model(self, model):
        x = tf.keras.layers.Input(shape=(None,84,84,1))
